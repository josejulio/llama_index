...
If you don't want to use OpenAI, you can use [any other LLM](../../module_guides/models/llms/modules.md) including local models. Agents require capable models, so smaller models may be less reliable.
